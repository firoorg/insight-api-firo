 ...
 */
MongoConnector.prototype.bestBlock = function(){
    if(this._blocks.length <= 0){
        return 0;
    }
    return this._blocks[this._blocks.length-1].hash;
}

/**
 * Get top n address order by balances
 */
MongoConnector.prototype.get_top = function(n){
 ...
 */
MongoConnector.prototype.insert_block = function(block){
