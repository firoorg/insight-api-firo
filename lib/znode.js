...
ZNodeController.prototype.ZNodeCount = function (req, res) {
  console.log("this.node.services.bitcoind: ", this.node.services.bitcoind)
  this.node.services.bitcoind.evoznode("count", function (err, response) {
    if (err) {
      res.jsonp(err);
    }
    res.jsonp(response);
